...
class Login{
	        ...
	        while(5){
			    ...
			    switch(menu){
					...
					case 1 :{
						...
						case 4:{
							string marketing[] = {"propaganda_junina"}; 
	...
	op.push_back("Alice");
	op.push_back("Lucia");
	op.push_back("Mathias");
	op.push_back("Nathalia");
	op.push_back("Gabriel");
	op.push_back("Matheus");
	op.push_back("Marilia");
	op.push_back("Gabriela");
	op.push_back("Beatriz");
	op.push_back("Julia");
	op.push_back("Juliana");
	...
	for(it = func.begin(),ito = op.begin() ; it != func.end(),ito != op.end();it++,ito++){
		cout << "\t\t\t\t\t\t\t"<< "O(A) funcionario " << *ito << " teve rendimento de nota " << *it << " .\n";
    }
	...
	if(melhores.is_open()){
		melhores << "\t\t\t\t\t\t\t"<< "Funcionarios com rendiento acima da media: ";
		for(it2 = funcok.begin(); it2 != funcok.end();it2++){
	    melhores << *it2 << " ";
    }
    melhores.close();
	...
	if(abaixo.is_open()){
		abaixo << "\t\t\t\t\t\t\t"<< "Funcionarios com rendiento abaixo da media: ";
		for(it3 = funclow.begin(); it3 != funclow.end();it3++){
	    abaixo << *it3;
    }
    abaixo.close();
